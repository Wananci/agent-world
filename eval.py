...
from utils.droid_data_utils import get_mydroid_dataset
from utils.distributed_utils import init_distributed_device, world_info_from_env
from utils.utils_eval_droid import eval_one_epoch_droid_ddp
...
def main():
    ...
    droid_dataset = get_mydroid_dataset(args, model.image_processor, clip, epoch=0, split='test')
